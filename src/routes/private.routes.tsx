...
import { injectPushNotification } from "../context/NotificationContext"

const Stack = createNativeStackNavigator<Routes>()

function PrivateRoutesTree() {
    return (
...
export const PrivateRoutes = injectPushNotification(PrivateRoutesTree)
